    ...
    if investment_amount is not None:
        ...
        if investment_amount < 5000:
            return build_validation_result(
                False,
                "investmentAmount",
                "The amount to convert must be grater than $5000. Please provide a valid amount."
                )
...
def recommend_portfolio(intent_request):
    ...
    # Dictionary to hold investment recommendations based on risk levels
    risk_levels = {
        "none": "100% bonds (AGG), 0% equities (SPY)",
        "low": "60% bonds (AGG), 40% equities (SPY)",
        "medium": "40% bonds (AGG), 60% equities (SPY)",
    ...
    return close(
        ...
        "Fulfilled",
        {
            ...
            "content": """Thank you for submitting, we suggest this option for your retirement fund:
                {}""".format(risk_levels[risk_level.lower()]),
        },)
